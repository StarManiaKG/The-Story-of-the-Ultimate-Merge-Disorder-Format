...
AppVersion={#UZB_GetVersionString} ({#UZB_arch})
...
DefaultDirName={userpf}\Ultimate Zone Builder
...
Source: UZBScript\uzbscript.d.ts; DestDir: {app}\UZBScript; Flags: ignoreversion
Source: UZBScript\Libraries\*; DestDir: {app}\UZBScript\Libraries; Flags: ignoreversion recursesubdirs
Source: UZBScript\Scripts\Examples\*; DestDir: {app}\UZBScript\Scripts\Examples; Flags: ignoreversion recursesubdirs
...
Source: Plugins\UZBScript.pdb; DestDir: {app}\Plugins; Flags: ignoreversion
...
begin
	...
	begin
		...
		// Remove configs
		DeleteFile(ExpandConstant('{localappdata}\Doom Builder\UZBuilder.cfg'));
		DeleteFile(ExpandConstant('{localappdata}\Doom Builder\UZBuilder.log'));
		DeleteFile(ExpandConstant('{localappdata}\Doom Builder\UZBCrash.txt'));
	end;
end;